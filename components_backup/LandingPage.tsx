    ...
    <div className="bg-zinc-950 min-h-screen text-white overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-6 lg:space-y-8 relative z-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                onClick={onStart}
                className="group bg-emerald-600 text-white px-8 py-4 lg:px-10 lg:py-5 rounded-2xl font-black text-lg lg:text-xl hover:bg-emerald-500 transition-all shadow-[0_0_20px_-5px_rgba(16,185,129,0.3)] hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.5)] active:scale-95 flex items-center justify-center gap-2"
              >
                Começar Agora
      ...
      <section className="py-24 px-6 relative overflow-hidden text-center border-t border-white/10 bg-zinc-950">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <button
            onClick={onStart}
            className="bg-emerald-500 text-white px-12 py-6 rounded-2xl font-black text-xl hover:bg-emerald-400 active:scale-95 transition-all shadow-[0_0_40px_-15px_rgba(16,185,129,0.4)]"
          >
