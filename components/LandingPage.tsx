      ...
      <section className="relative pt-32 pb-16 lg:pt-48 lg:pb-32 px-6 max-w-7xl mx-auto z-10 w-full overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-6 lg:space-y-8 relative z-20">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-white leading-[1.1] sm:leading-[1.1]">
              O Futuro da sua <br/>
          ...
          <div className="relative group perspective-[2000px] z-10 max-w-full mx-auto lg:max-w-none px-2 sm:px-0">
            {/* Glow Behind */}
          ...
          <div className="relative group">
            <div className="relative z-10 mx-auto max-w-sm">
               <div className="glass-panel p-2 rounded-[3rem] border border-white/10 shadow-2xl">
                 ...
                 <div className="absolute top-8 right-[-10px] sm:right-[-20px] glass-panel p-3 sm:p-4 rounded-xl border-l-2 border-emerald-500 animate-float delay-200">
                 ...
                 <div className="absolute bottom-20 left-[-10px] sm:left-[-20px] glass-panel p-3 sm:p-4 rounded-xl border-r-2 border-emerald-500 animate-float">
