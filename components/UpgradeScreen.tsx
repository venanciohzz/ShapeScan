...
const UpgradeScreen: React.FC<UpgradeScreenProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <h1 className="text-3xl font-black text-gray-900 mb-4">Seja ShapeScan Premium</h1>
      ...
      <button 
        onClick={() => window.open('https://cakto.com.br/checkout/shapescan', '_blank')}
