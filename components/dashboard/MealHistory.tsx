            ...
            {todayLogs.length > 0 ? (
                <div className="space-y-4">
                    {todayLogs.map((log) => (
                        <div
                            key={log.id}
                            className="group relative bg-zinc-900/50 backdrop-blur-2xl p-6 rounded-[2rem] hover:bg-zinc-800/60 transition-all duration-500 shadow-xl flex justify-between items-center active:scale-[0.99]"
                        >
                            {/* Hover Glow */}
